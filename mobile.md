...
- [Resources](#resource)
- [Mobile Flowchart](#mobile-flowchart)
...
flowchart LR
    ...
    subgraph Analyze
        B[Static / Dynamic]
        C[Traffic / Storage / Code]
    end
    subgraph Exploit
        D[Hardcoded / Insecure Config]
    end
    A --> B --> C --> D
```

> **Read more:** For additional tools and references, see [Resources](#resource) below.
...
| --- | --- | --- |
| APK / IPA | Apktool, decompile, rebuild | See Apktool section; Resources (MobSF, dex2jar). |
| Frida / hooking | medusa, instrumentation | See Resources; Mobile Application Pentest Cheat Sheet. |
