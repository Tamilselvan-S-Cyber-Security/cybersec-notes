...
- [Resources](#resources)
- [Evasion Flowchart](#evasion-flowchart)
...
flowchart LR
    subgraph Payload
        A[Shellcode / PE / Script]
    end
    subgraph Obfuscate
        B[AMSI Bypass / Encode / Pack]
    end
    subgraph Load
        C[Loader / Donut / In-memory]
    end
    subgraph Execute
        D[Bypass AV/EDR]
    end
...
| --- | --- | --- |
| Shellcode / loaders | Donut, Shhhloader, Mangle, ScareCrow | See AMSI, Shhhloader, Resources sections above. |
| Obfuscation | Invoke-Obfuscation, Chimera; bypass strings | See Resources; Evasion flowchart. |
