...
- [Resources](#resources)
- [Cryptography Flowchart](#cryptography-flowchart)
...
flowchart LR
    subgraph Identify
        A[Hash / Cipher / Encoding]
    end
    subgraph Analyze
        B[Type / Mode / Key]
    end
    subgraph Attack
        C[Decode / Decrypt / Crack]
    end
    subgraph Verify
        D[Plaintext / Key]
    end
...
| --- | --- | --- |
| Hash / cipher | Ciphey, hash-identifier, OpenSSL | See hash-identifier, OpenSSL, Ciphey in Resources. |
| Keys / decode | RSA, GPP, pickle; decryption commands | See RSA, Creating Password Hashes, Python Pickle sections. |
