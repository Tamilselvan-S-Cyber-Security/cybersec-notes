...
- [Resources](#resources)
- [Simulation & Emulation Flowchart](#simulation--emulation-flowchart)
...
## Simulation & Emulation Flowchart

```mermaid
flowchart LR
    subgraph Plan
        A[Scenario / ATT&CK / TTP]
    end
    subgraph Execute
        B[Atomic / Caldera / Purple]
    end
    subgraph Collect
        C[Telemetry / Detections]
    end
    subgraph Improve
        D[Gaps / Tune / Report]
    end
...
| --- | --- | --- |
| Atomic tests | Invoke-AtomicRedTeam, atomics | See Atomic Red Team section; Resources. |
| Emulation | Caldera, PurpleSharp, Stratus Red Team | See Resources; Simulation & Emulation flowchart. |
