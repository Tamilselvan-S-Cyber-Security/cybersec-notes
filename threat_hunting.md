...
- [Resources](#resources)
- [Threat Hunting Flowchart](#threat-hunting-flowchart)
...
| --- | --- | --- |
| Hunt queries | KQL, Sysmon, process injection table | See KQL, Sysmon Event Codes, Hunting Process Injection. |
| IOCs / beacons | Shodan, Decider, Hunt-Sleeping-Beacons | See Threat Hunting with Shodan; Resources. |
