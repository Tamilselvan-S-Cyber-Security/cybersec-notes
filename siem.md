...
| --- | --- | --- |
| Event IDs / detection | Windows Event IDs, Sysmon, ACL checks | See Event Log Analysis, tables above. |
| Query / rules | KQL, Sigma, detection logic | See Detect Golden Ticket, Kerberoast; Resources. |
