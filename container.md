...
flowchart LR
    subgraph Enumerate
        A[Docker / K8s / Runtime]
        B[Images / Pods / Config]
    end
    subgraph Exploit
        C[Escape / PrivEsc]
        D[Secrets / API]
...
| --- | --- | --- |
| Docker / K8s | deepce, kubectl, escape payloads | See deepce, Docker, Kubernetes sections; Resources. |
| Secrets / API | Image scan, RBAC, token abuse | See kubectl, kubeletctl; Resources. |
