...
- [Resources](#resources)
- [Wordlists Flowchart](#wordlists-flowchart)
...
| Subject | Description |
| --- | --- |
| Additional resources | See Resources (SecLists, CeWL, CUPP, bopscrk, etc.). |
| Wordlist workflow | Source → Generate → Mutate → Use; see flowchart. |

## More tables

| Reference | Location |
| --- | --- |
| Generators | CeWL, CUPP, crunch, maskprocessor in sections above. |
| Mutation | Mutate Wordlists, Username Anarchy sections. |

## Tools and commands

| Category | Example |
| --- | --- |
| CeWL / CUPP | See respective sections for CLI options. |
| Username Anarchy | `./username-anarchy -f first,first.last -i <FILE>` — see above. |

## Payloads table

| Type | Description | Reference |
| --- | --- | --- |
| Wordlists | Passwords, usernames, fuzz lists | See CeWL, CUPP, crunch, SecLists in Resources. |
| Mutation | Rules, combinator output | See Mutate Wordlists, Username Anarchy sections. |
