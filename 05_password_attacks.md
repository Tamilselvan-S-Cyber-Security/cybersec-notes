...
- [Resources](#resources)
- [Password Attacks Flowchart](#password-attacks-flowchart)
...
## Password Attacks Flowchart

```mermaid
flowchart LR
    subgraph Collect
        A[Capture / Dump Hashes]
        B[Extract from Memory / Files]
    end
    subgraph Crack
        C[Identify Hash Type]
        D[Wordlist / Rule / Spray]
    end
    subgraph Use
        E[Pass-the-Hash / PTH]
        F[Authenticate & Escalate]
    end
    A --> B --> C --> D --> E --> F
```
...
| --- | --- | --- |
| Hashes / credentials | NTLM, Kerberos, DPAPI, GPP | See mimikatz, hashcat, LaZagne, GPP sections. |
| Spray / crack | Wordlists, rules, spray timing | See Hydra, Kerbrute, Spray-Passwords, Resources. |
