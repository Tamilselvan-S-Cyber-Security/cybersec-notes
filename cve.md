...
flowchart LR
    subgraph Identify
        A[CVE ID / Product / Version]
    end
    subgraph Research
        B[Exploit-DB / PoC / Patch]
    end
    subgraph Exploit
        C[Verify / Adapt / Run]
    end
...
> **Read more:** For exploit databases and references, see [Resources](#resources) and [Exploit Databases](#exploit-databases) below.
...
| --- | --- | --- |
| CVE PoC / exploits | searchsploit, Exploit-DB, per-CVE sections | See Exploit Databases; each CVE section in this handbook. |
| LPE / RCE | ZeroLogon, PrintNightmare, Dirty Pipe, etc. | See CVE flowchart; Resources table. |
