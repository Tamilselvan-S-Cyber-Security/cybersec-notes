...
- [Persistence Flowchart](#persistence-flowchart)
...
flowchart LR
    ...
    subgraph Maintain
        D[Survive Reboot / Evade]
    end
    A --> B --> C --> D
```

> **Read more:** See sections below for detailed techniques and references.
...
| Subject | Description |
| --- | --- |
| Additional resources | See sections above for each persistence technique. |
| Persistence types | Registry, services, scheduled tasks, WMI, COM, etc. |

## More tables

| Reference | Location |
| --- | --- |
| Technique list | See Table of Contents for ADS, COM, Task Scheduler, etc. |
| Examples | Each section includes commands and syntax. |

## Tools and commands

| Category | Example |
| --- | --- |
| Registry / services | See Backdoor Services, Registry sections. |
| Scheduled task | `schtasks`; see Task Scheduler section. |

## Payloads table

| Type | Description | Reference |
| --- | --- | --- |
| Registry / services | Backdoor commands, service binaries | See Backdoor Services, Registry sections. |
| Scheduled / WMI | Task XML, WMI subscriptions | See Task Scheduler, Logon Triggered sections. |
