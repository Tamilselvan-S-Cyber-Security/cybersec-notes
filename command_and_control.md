...
- [Resources](#resources)
- [Command and Control Flowchart](#command-and-control-flowchart)
...
## Command and Control Flowchart

```mermaid
flowchart LR
    subgraph Deploy
        A[Listener / Redirector]
        B[Payload / Implant]
    end
...
| --- | --- | --- |
| Beacons / implants | Cobalt Strike, Sliver, Havoc, Mythic | See Metasploit, Sliver, Havoc sections; Resources. |
| Malleable C2 / redirectors | Profile, listener, proxy | See Redirector, BOF; Resources. |
