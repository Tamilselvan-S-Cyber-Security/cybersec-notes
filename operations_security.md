...
- [Resources](#resources)
- [Operations Security Flowchart](#operations-security-flowchart)
...
## Operations Security Flowchart

```mermaid
flowchart LR
    subgraph Plan
        A[Op / TTP / Detection Risk]
    end
    subgraph Minimize
        B[Logs / Traces / Artifacts]
    end
    subgraph Evade
        C[ETW / AMSI / Proxy / Clean]
    end
    subgraph Validate
        D[Test / Verify OPSEC]
    end
...
| --- | --- | --- |
| OPSEC / tradecraft | Log cleaning, proxy, ETW bypass | See Logfile Cleaning, ProxyChains, ETW sections. |
| LOLBAS / living-off | Native binaries, scripted payloads | See LOLBAS section; avoid IEX/IWR; Resources. |
