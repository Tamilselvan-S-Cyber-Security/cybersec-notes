...
- [Resources](#resources)
- [Decrypter Flowchart](#decrypter-flowchart)
...
| Subject | Description |
| --- | --- |
| Additional resources | See Resources (firefox_decrypt, gpp-decrypt, Jenkins, etc.). |
| Decrypt workflow | Locate → Identify → Decrypt → Extract; see flowchart. |

## More tables

| Reference | Location |
| --- | --- |
| Tool list | openfire_decrypt, splunksecrets; see sections and Resources. |
| Targets | mRemoteNG, Roundcube, Node-RED, Lansweeper in Resources. |

## Tools and commands

| Category | Example |
| --- | --- |
| openfire_decrypt | See openfire_decrypt section. |
| splunksecrets | `splunksecrets splunk-decrypt -S splunk.secret` — see above. |

## Payloads table

| Type | Description | Reference |
| --- | --- | --- |
| Decrypt inputs | Encrypted config, DB, vault files | See openfire_decrypt, splunksecrets sections. |
| Key / secret | Passwords, keys for decryption | See Resources (gpp-decrypt, Jenkins, mRemoteNG). |
