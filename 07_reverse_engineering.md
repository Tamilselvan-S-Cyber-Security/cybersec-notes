...
- [Resources](#resources)
- [Reverse Engineering Flowchart](#reverse-engineering-flowchart)
...
flowchart LR
    ...
    subgraph Analyze
        B[Static: Disassemble / Decompile]
        C[Dynamic: Debug / Trace]
    end
    subgraph Understand
        D[Identify Logic / Crypto / APIs]
        E[Map Behavior]
    end
    subgraph Document
        F[Document & Report]
...
| --- | --- | --- |
| Disasm / decompile | Ghidra, Radare2, Rizin, dnSpy | See Ghidra, Radare2, Rizin sections; Resources. |
| Debug / trace | GDB, x64dbg, WinDbgX; breakpoints | See GDB, peda, GEF; Resources. |
