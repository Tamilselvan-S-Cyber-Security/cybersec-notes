...
- [Resources](#resources)
- [Social Engineering Tools Flowchart](#social-engineering-tools-flowchart)
...
## Social Engineering Tools Flowchart

```mermaid
flowchart LR
    subgraph Prepare
        A[Phishing Server / Phishlet]
        B[Campaign / Lure]
    end
    subgraph Deliver
        C[Email / Link / QR]
...
| --- | --- | --- |
| Phishlets / lures | Evilginx2, Gophish, Modlishka | See Evilginx2, Gophish, Storm Breaker sections. |
| Credential harvest | SET, Site Cloner, swaks | See SET Credential Harvesting; Resources. |
