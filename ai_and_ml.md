...
- [Resources](#resources)
- [AI & ML Flowchart](#ai--ml-flowchart)
...
flowchart LR
    subgraph Scope
        A[Use Case / Attack Surface]
    end
    subgraph Prompt
        B[LLM / Prompt Engineering]
    end
    subgraph Exploit
        C[Jailbreak / Injection / Abuse]
    end
    subgraph Defend
        D[Detect / Harden / Monitor]
    end
    A --> B --> C --> D
```
...
| --- | --- | --- |
| Prompt injection | garak, promptmap2; jailbreak prompts | See AI & ML Prompts, LinkedIn Profile Prompt; Resources. |
| LLM abuse | AttackGen, Vulnhuntr, RamiGPT | See Resources table. |
