...
- [Resources](#resources)
- [Wireless Attacks Flowchart](#wireless-attacks-flowchart)
...
## Wireless Attacks Flowchart

```mermaid
flowchart LR
    subgraph Monitor
        A[Put Interface in Monitor Mode]
        B[Identify Target AP / Client]
    end
    subgraph Capture
        C[Capture Handshake / Traffic]
        D[Deauth if Needed]
    end
    subgraph Crack
        E[Crack WEP / WPA / WPS]
...
| --- | --- | --- |
| WPA/WEP handshake | Capture, aircrack wordlists | See Aircrack-ng, WPS-PSK Example Attack sections. |
| Evil twin / EAP | eaphammer, credentials | See Apple Wi-Fi Evil SSID, eaphammer; Resources. |
