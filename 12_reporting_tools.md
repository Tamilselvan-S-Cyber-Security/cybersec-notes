...
- [Resources](#resources)
- [Reporting Tools Flowchart](#reporting-tools-flowchart)
...
## Reporting Tools Flowchart

```mermaid
flowchart LR
    subgraph Collect
        A[Findings / Screenshots / Logs]
    end
    subgraph Organize
        B[Folder Structure / Tags]
        C[Evidence Index]
    end
    subgraph Write
        D[Draft / Templates]
...
| --- | --- | --- |
| Report content | Findings, screenshots, evidence index | See Folder Structure, Logging, Markdown sections. |
| Templates | PwnDoc, WriteHat, Obsidian | See Resources table; Meetings table above. |
