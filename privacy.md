...
- [Resources](#resources)
- [Privacy Flowchart](#privacy-flowchart)
...
| --- | --- | --- |
| Browser / config | Firefox telemetry off, about:config | See Mozilla Firefox, oniux sections. |
| VPN / Tor / email | ProxyChains, Signal, Tails; see Resources | See Resources table; Privacy flowchart. |
