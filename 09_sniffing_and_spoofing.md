...
- [Resources](#resources)
- [Sniffing & Spoofing Flowchart](#sniffing--spoofing-flowchart)
...
## Sniffing & Spoofing Flowchart

```mermaid
flowchart LR
    subgraph Position
        A[MITM / Same LAN / Proxy]
    end
    subgraph Intercept
        B[DNS Spoof / LLMNR Poison]
        C[Capture Traffic]
    end
    subgraph Abuse
        D[Relay / Credential Capture]
        E[Session Hijack / Modify]
    end
    A --> B --> C --> D --> E
```
...
| --- | --- | --- |
| DNS / LLMNR poison | DNSChef, Responder, mitm6 | See DNSChef, Responder sections; Resources. |
| Capture / relay | NTLM relay, credential capture | See Responder; see 10 Post Exploitation handbook. |
