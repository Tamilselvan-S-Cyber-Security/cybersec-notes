...
- [Templates Flowchart](#templates-flowchart)
...
flowchart LR
    subgraph Phase
        A[Recon / Vuln / Web / etc.]
    end
    subgraph Template
        B[Checklist / Snippets]
    end
    subgraph Apply
        C[Copy / Adapt / Run]
    end
...
> **Read more:** See sections below for phase-specific templates and examples.
...
| Subject | Description |
| --- | --- |
| Additional resources | See phase-specific templates in sections above. |
| Phases | Recon, Vuln, Web, Database, Password, Wireless, etc. |

## More tables

| Reference | Location |
| --- | --- |
| Phase templates | 01–13 and topic sections in this handbook. |
| Snippets | HTML injection, Python skeleton, etc. in sections above. |

## Tools and commands

| Category | Example |
| --- | --- |
| By phase | See each numbered section for checklists and commands. |
| Exploit skeleton | See Exploiting / Python section for template. |

## Payloads table

| Type | Description | Reference |
| --- | --- | --- |
| Phase templates | Checklists, snippets per phase | See 01–13 and topic sections above. |
| Exploit / PoC | Python skeleton, HTML injection | See Exploiting, 03 Web Application sections. |
