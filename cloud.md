...
- [Resources](#resources)
- [Cloud Flowchart](#cloud-flowchart)
...
flowchart LR
    subgraph Discover
        A[Enumerate Services / Permissions]
    end
    subgraph Access
        B[Creds / Keys / Misconfig]
    end
    subgraph Exploit
        C[PrivEsc / Lateral / Exfil]
    end
    subgraph Persist
        D[Backdoors / Persistence]
    end
    A --> B --> C --> D
```
...
| --- | --- | --- |
| AWS / Azure / M365 | Pacu, ROADtools, GraphRunner, MFASweep | See AWS, Microsoft Azure sections; Resources. |
| Keys / secrets | S3, lazy enumeration, credential dump | See lazys3, S3 Account Search; Resources. |
