...
- [Resources](#resources)
- [Forensics Flowchart](#forensics-flowchart)
...
flowchart LR
    ...
    subgraph Preserve
        B[Hash / Chain of Custody]
    end
    subgraph Analyze
        C[File / Memory / Timeline]
        D[Artifacts / IOCs]
    end
    subgraph Report
        E[Document & Report]
...
| --- | --- | --- |
| Artifact extraction | volatility, Autopsy, KAPE; memory/disk | See volatility, Autopsy, KAPE in Resources. |
| Steganography / decode | zsteg, xxd, binwalk; payload extraction | See zsteg, xxd sections above. |
